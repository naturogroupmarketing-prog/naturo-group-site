...
export const footerLocations = {
  'Geelong': [
    ...
    { label: 'East Geelong', href: '/house-cleaning-east-geelong' },
    { label: 'South Geelong', href: '/house-cleaning-south-geelong' },
    ...
    { label: 'Wandana Heights', href: '/house-cleaning-wandana-heights' },
    { label: 'Manifold Heights', href: '/house-cleaning-manifold-heights' },
    { label: 'Herne Hill', href: '/house-cleaning-herne-hill' },
    { label: 'Hamlyn Heights', href: '/house-cleaning-hamlyn-heights' },
    { label: 'Bell Park', href: '/house-cleaning-bell-park' },
    { label: 'Bell Post Hill', href: '/house-cleaning-bell-post-hill' },
    { label: 'Norlane', href: '/house-cleaning-norlane' },
    { label: 'North Shore', href: '/house-cleaning-north-shore-geelong' },
    { label: 'Corio', href: '/house-cleaning-corio' },
    { label: 'Lara', href: '/house-cleaning-lara' },
    { label: 'Armstrong Creek', href: '/house-cleaning-armstrong-creek' },
    { label: 'Grovedale', href: '/house-cleaning-grovedale' },
    { label: 'Waurn Ponds', href: '/house-cleaning-waurn-ponds' },
    { label: 'Mount Duneed', href: '/house-cleaning-mount-duneed' },
    { label: 'Newcomb', href: '/house-cleaning-newcomb' },
    { label: 'Whittington', href: '/house-cleaning-whittington' },
    { label: 'St Albans Park', href: '/house-cleaning-st-albans-park' },
    { label: 'Thomson', href: '/house-cleaning-thomson' },
    { label: 'Moolap', href: '/house-cleaning-moolap' },
    { label: 'Breakwater', href: '/house-cleaning-breakwater' },
    { label: 'North Geelong', href: '/house-cleaning-north-geelong' },
    { label: 'Rippleside', href: '/house-cleaning-rippleside' },
    { label: 'Fyansford', href: '/house-cleaning-fyansford' },
    { label: 'Ceres', href: '/house-cleaning-ceres' },
    { label: 'Batesford', href: '/house-cleaning-batesford' },
    { label: 'Lovely Banks', href: '/house-cleaning-lovely-banks' },
    { label: 'Marshall', href: '/house-cleaning-marshall' },
    { label: 'Charlemont', href: '/house-cleaning-charlemont' },
  ],
  'Bellarine Peninsula': [
    ...
    { label: 'Wallington', href: '/house-cleaning-wallington' },
    { label: 'Connewarre', href: '/house-cleaning-connewarre' },
    { label: 'Clifton Springs', href: '/house-cleaning-clifton-springs' },
    { label: 'Portarlington', href: '/house-cleaning-portarlington' },
    { label: 'St Leonards', href: '/house-cleaning-st-leonards' },
    { label: 'Indented Head', href: '/house-cleaning-indented-head' },
    { label: 'Point Lonsdale', href: '/house-cleaning-point-lonsdale' },
    { label: 'Queenscliff', href: '/house-cleaning-queenscliff' },
    { label: 'Marcus Hill', href: '/house-cleaning-marcus-hill' },
  ],
  'Surf Coast': [
  ...
  'Port Macquarie & Mid North Coast': [
    ...
    { label: 'Dunbogan', href: '/house-cleaning-dunbogan' },
    { label: 'Camden Head', href: '/house-cleaning-camden-head' },
    { label: 'Telegraph Point', href: '/house-cleaning-telegraph-point' },
    { label: 'Sancrox', href: '/house-cleaning-sancrox' },
    { label: 'Kendall', href: '/house-cleaning-kendall' },
    { label: 'Comboyne', href: '/house-cleaning-comboyne' },
    { label: 'Beechwood', href: '/house-cleaning-beechwood' },
    { label: 'Bago', href: '/house-cleaning-bago' },
    { label: 'Rollands Plains', href: '/house-cleaning-rollands-plains' },
    { label: 'Pembrooke', href: '/house-cleaning-pembrooke' },
    { label: 'Kew', href: '/house-cleaning-kew-port-macquarie' },
    { label: 'Lakewood', href: '/house-cleaning-lakewood' },
    { label: 'King Creek', href: '/house-cleaning-king-creek' },
