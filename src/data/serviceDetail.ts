...
export const serviceDetails: Record<string, ServiceDetail> = {
  ...
  'end-of-lease': {
    ...
    whatsIncluded: [
      {
        group: 'Real estate checklist',
        items: [
          'Inside oven, range hood, stovetop and grill',
          'Inside cabinets, drawers and wardrobes',
          'Detailed bathroom and toilet detail clean',
          'Internal windows, tracks and flyscreens',
        ],
      },
      {
        group: 'Whole property',
        items: [
          'Walls spot-cleaned of marks',
          'Skirting boards, doors and door frames',
          'Air conditioner filters and exhaust fans',
      ...
      },
      {
        ...
        items: [
          'Carpet steam cleaning (with receipt)',
          'External windows',
